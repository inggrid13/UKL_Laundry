...
if($_POST){
    ...
    if(empty($nama)){
        ...
        include "koneksi.php";
            $update=mysqli_query($conn,"update user set nama='".$nama."',username='".$username."', alamat='".$alamat."',kota='".$kota."',password='".md5($password)."', role='".$role."' where id = '".$id."' ") or die(mysqli_error($conn));
            if($update){
